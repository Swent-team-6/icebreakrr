...
fun NotificationScreen(navigationActions: NavigationActions) {
    val cardList = remember { mutableStateOf(listOf("Michelle", "Paul", "Francois", "Jean", "Van Dam", "Schwartzy", "Otto", "Gunter", "Stuart")) }
    Scaffold(
      ...
      floatingActionButton = {
          FloatingActionButton(
              ...
              modifier = Modifier.testTag("testFilter"),
...
fun TopAppBarNotification(){
    Row(
        ...
        TopAppBar(
            ...
            colors = TopAppBarColors(IceBreakrrBlue, Color.Blue, Color.Blue, Color.White, Color.White),
