...
// Tests written with the help of CursorAI, I know the tests may be weird since everything is mocked but I don't know how else to test
class NetworkUtilsTest {
    ...
    fun setUp() {
        ...
        `when`(context.getSystemService(ConnectivityManager::class.java)).thenReturn(connectivityManager)
